...
export default function GalleryManager() {
  ...
  const [subTab, setSubTab] = useState('images'); // 'images' | 'videos'
  ...
  // 1. Fetch Existing Gallery Media
  useEffect(() => {
  ...
  // 3. Save Selected Photo Dump to MongoDB
  const handleBulkImageSubmit = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setNewImages([]);
        alert('Photos successfully saved to gallery!');
      } else {
  ...
  // 4. Auto-convert YouTube watch/shorts/youtu.be links
