...
export default function Footer() {
  ...
  return (
    <footer style={{ background: '#050505', position: 'relative', borderTop: '1px solid rgba(255,255,255,0.05)', color: '#fff' }}>
      ...
      <div style={{ padding: '80px var(--page-gutter) 60px', maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '2fr 1fr 1fr', gap: '60px' }} className="footer-grid">
        ...
        <div>
          ...
          <div style={{ marginTop: 24, paddingTop: 24, borderTop: '1px solid rgba(255,255,255,0.1)', display: 'flex', gap: 16 }}>
            <a href="https://l.instagram.com/?u=https%3A%2F%2Fwa.me%2Fmessage%2FK2QXG7JA2TU7C1&e=AUC2E2bLyvAM1DGu917kI5jhodtlVSpr6wPtWS0beeNbklrGIHkVOpXiRXHEdU-DxFjHjhJc-zyGrVaZo_sKwaqGqh05ZydDJ7He740Z4E5xIssqlneE-u1YfPFSKH--A7J2SztXI1nqrZZFyzrR46hSGbin4muVDfjwTA" 
            aria-label="WhatsApp" className="social-btn whatsapp">
            ...
            <a href="https://www.instagram.com/pankaj_studio_deoria" aria-label="Instagram" className="social-btn instagram">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://www.facebook.com/people/Pankaj-Studio-Deoria/100094782644862/#" aria-label="Facebook" className="social-btn facebook">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </a>
            <a href="https://www.youtube.com/@PankajStudioDeoria" aria-label="YouTube" className="social-btn youtube">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
      ...
      {/* 🌟 BOTTOM BAR (Admin Link Added Here) 🌟 */}
      ...
      <style>{`
        ...
        /* 🌟 Admin Link Styling: Dim color normal state, bright on hover 🌟 */
        .admin-hidden-link {
          color: rgba(255,255,255,0.15); /* Bahut halka color */
          text-decoration: none;
          transition: color 0.3s ease;
        }
        .admin-hidden-link:hover {
          color: #d4af37; /* Hover pe gold ho jayega */
        }
